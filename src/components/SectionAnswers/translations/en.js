export const SectionAnswersTranslationsEn = {
  'Question-1': 'How to rent items?',
  'Answer-1':
  ...
  'Question-3': 'Can I reserve a dress in advance?',
  'Answer-3':
    'Certainly! You can send a reservation request and wait for approval within 24 hours.',

  'Question-4': 'How long does the rental last?',
  'Answer-4':
  ...
  'Question-5': "What if the dress doesn't fit?",
  'Answer-5':
  ...
  'Question-7': 'How to return the item?',
  'Answer-7':
  ...
  'Question-8': 'What to do if I am late with the return of the rented item?',
  'Answer-8':
