import { AboutUsPageTranslationsCs } from 'pages/AboutUsPage/translations/cs';
import { DecorAndToysPageTranslationsCs } from 'pages/DecorAndToysPage/translations/cs';
...
import { RentOutTranslationsCs } from 'pages/UserPage/Pages/RentOut/translations/cs';
import { UserPageTranslationsCs } from 'pages/UserPage/translations/cs';

export const PagesTranslationsCs = {
  popularPage: PopularPageTranslationsCs,
